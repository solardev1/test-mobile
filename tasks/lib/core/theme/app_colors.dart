...
class AppColors {
  ...
  static const Color primaryLigthBackground = Color.fromARGB(255, 225, 224, 242);
  ...
  //priority colors
static const Color low = Color(0xFF48BC1A);
static const Color medium = Color(0xffF99233);
static const Color edit = Color.fromARGB(255, 73, 143, 224);
